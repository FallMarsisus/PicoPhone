...
def http_post(url: str, body: str, content_type: str) -> str: ...
...
class style_t:
    ...
    # def transition_dsc_init(self, tr: lv_style_transition_dsc_t, props: int, path_cb: int, time: int, sleep_ms: int, user_data: int): ...
...
class meter(lv_obj):
    ...
    # def add_needle_img(self, scale: meter_scale_t, src: any, pivot_x: int, pivot_y: int) -> meter_indicator_t: ...
